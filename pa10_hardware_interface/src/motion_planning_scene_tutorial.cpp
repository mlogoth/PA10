...
int main(int argc, char **argv)
{
  ...
  attached_object.link_name = "link_ee_tool";
  /* The header must contain a valid TF frame*/
  attached_object.object.header.frame_id = "link_ee_tool";
  ...
  ROS_INFO("Adding the object into the world at the location of the ee tool link.");
  ...
  detach_object.link_name = "link_ee_tool";
